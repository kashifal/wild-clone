<template>
    ...
    <div
      class="z-40 xl:block hidden overflow-hidden h-screen w-[24%] fixed right-0 top-16 bg-[#1C2C3C]"
    >
    ...
    <div class="flex items-center justify-center group text-[#77808A]  hover:text-white cursor-pointer transition-all duration-500 hover:bg-[#214058] py-2 px-4 gap-1">
      ...
      <div class="h-[500px] sidebar overflow-auto top-[20%] bg-[#1C2C3C] absolute w-full">
