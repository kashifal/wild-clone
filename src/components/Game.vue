<template>
    <div class="">
        ...
        <div class="flex items-center px-3 py-2 rounded-md hover:bg-white hover:bg-opacity-[7%] cursor-pointer gap-1">
            ...
            <div class="px-2 py-[2px] bg-[#3FC02F] text-white text-xs rounded-full">43</div>
        </div>
    </div>
    <div class="pt-5 scrl overflow-x-auto flex items-center gap-3">
        <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
           <img src="../assets/gam1.svg" alt="" class="w-[132px] h-[32px]">
           <span class="bg-green-400 bg-opacity-10 text-[#5AD38A] font-medium text-xs rounded-full py-[2px] px-2">157 Games</span>
        </div>
    </a>
    <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
           <img src="../assets/gam2.svg" alt="" class="w-[132px] h-[32px]">
           <span class="bg-green-400 bg-opacity-10 text-[#5AD38A] font-medium text-xs rounded-full py-[2px] px-2">410 Games</span>
        </div>
    </a>
    <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
           <img src="../assets/gam3.svg" alt="" class="w-[132px] h-[32px]">
           <span class="bg-green-400 bg-opacity-10 text-[#5AD38A] font-medium text-xs rounded-full py-[2px] px-2">103 Games</span>
        </div>
    </a>
    <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
           <img src="../assets/gam4.svg" alt="" class="w-[132px] h-[32px]">
           <span class="bg-green-400 bg-opacity-10 text-[#5AD38A] font-medium text-xs rounded-full py-[2px] px-2">81 Games</span>
        </div>
    </a>
    <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
           <img src="../assets/gam5.svg" alt="" class="w-[132px] h-[32px]">
           <span class="bg-green-400 bg-opacity-10 text-[#5AD38A] font-medium text-xs rounded-full py-[2px] px-2">88 Games</span>
        </div>
    </a>
    <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
           <img src="../assets/gam6.svg" alt="" class="w-[132px] h-[32px]">
           <span class="bg-green-400 bg-opacity-10 text-[#5AD38A] font-medium text-xs rounded-full py-[2px] px-2">171 Games</span>
        </div>
    </a>
    <a href="#" class="">
        <div class="w-[180px] h-[100px] flex flex-col gap-1 items-center justify-center bg-[#192C3D] hover:bg-[#162838] transition-all duration-100 rounded-xl">
