<template>
    ...
    >
      <div class="flex items-center gap-2.5">
        ...
        <button class="relative h-8 w-8 hover:bg-green-500 hover:bg-opacity-20 rounded-lg transition-all duration-400 hidden md:flex items-center justify-center">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32" class="w-6 h-6 text-white"><path fill="currentColor" d="M7 22h13v-2H7zm0-5h10v-2H7zm0-7v2h13v-2zm18 9.59L21.42 16 25 12.41 23.59 11l-5 5 5 5z"></path>
            </svg>
          </span>
        </button>
        <div class="">
      ...
      <div class="bg-[#192C3D] p-1 md:flex hidden gap-2 items-center rounded-lg  ">
        ...
        <div>
          <div class="md:flex hidden lg:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-5 cursor-pointer text-white">
  ...
  <div class="">
    ...
    <div class="bg-[#0D2133] rounded-2xl p-6 max-w-3xl relative mx-auto">
      ...
      @click="modalOpen"
      class="">
      <div class="w-8 h-8 absolute right-5 top-3 rounded-lg hover:bg-white hover:bg-opacity-[7%] flex items-center cursor-pointer justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" width="1em" height="1em" viewBox="0 0 21 21">
      ...
      <div class="grid grid-cols-2 gap-2 pt-10">
          <button class="flex items-center gap-1 hover:bg-opacity-[7%] transition-all duration-100 justify-center text-white p-2.5 rounded-[8px] bg-white bg-opacity-[4%]">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" class="h-4 w-4">
                <g clip-path="url(#google_svg__a)">
                  <path fill="#fff" d="M15.844 8.184c0-.544-.044-1.09-.138-1.625H8.16v3.08h4.321a3.7 3.7 0 0 1-1.599 2.431v2h2.578c1.514-1.394 2.384-3.452 2.384-5.886"></path>
                  <path fill="#34A853" d="M8.16 16c2.158 0 3.977-.708 5.303-1.93l-2.578-2c-.717.488-1.643.765-2.722.765-2.087 0-3.857-1.408-4.492-3.301h-2.66v2.06A8 8 0 0 0 8.16 16"></path>
                  <path fill="#FBBC04" d="M3.668 9.534a4.8 4.8 0 0 1 0-3.063V4.41H1.011a8 8 0 0 0 0 7.184z"></path>
                  <path fill="#EA4335" d="M8.16 3.166a4.35 4.35 0 0 1 3.069 1.2l2.284-2.284A7.7 7.7 0 0 0 8.16 0 8 8 0 0 0 1.011 4.41l2.657 2.06C4.3 4.575 6.073 3.167 8.16 3.167"></path>
                </g>
                <defs>
                  <clipPath id="google_svg__a"><path fill="#fff" d="M0 0h16v16H0z"></path></clipPath>
                </defs></svg
              ><span class="text-sm font-semibold">Google</span>
              </button>

            <button class="flex hover:bg-opacity-[7%] transition-all duration-100 items-center gap-1 justify-center text-white p-2.5 rounded-[8px] bg-white bg-opacity-[4%]">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" class="h-4 w-4"><g clip-path="url(#telegram_svg__a)"><path fill="url(#telegram_svg__b)" d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16"></path><path fill="#fff" fill-rule="evenodd" d="M3.621 7.916a381 381 0 0 1 4.666-2.01c2.221-.924 2.683-1.085 2.984-1.09a.53.53 0 0 1 .31.093c.08.066.103.154.114.217.01.062.024.204.013.315-.12 1.265-.641 4.334-.906 5.751-.112.6-.333.8-.547.82-.465.043-.817-.307-1.267-.602-.704-.461-1.102-.748-1.786-1.199-.79-.52-.277-.806.173-1.274.117-.122 2.164-1.984 2.204-2.153.005-.021.01-.1-.037-.141-.047-.042-.116-.028-.166-.017q-.105.025-3.374 2.23-.48.33-.868.321c-.285-.006-.835-.161-1.243-.294-.501-.163-.9-.249-.865-.525q.027-.217.595-.442" clip-rule="evenodd"></path></g><defs><linearGradient id="telegram_svg__b" x1="8" x2="8" y1="0" y2="15.881" gradientUnits="userSpaceOnUse"><stop stop-color="#2AABEE"></stop><stop offset="1" stop-color="#229ED9"></stop></linearGradient><clipPath id="telegram_svg__a"><path fill="#fff" d="M0 0h16v16H0z"></path></clipPath></defs></svg>
              <span class="text-sm font-semibold">Telegram</span>
            </button>
            
      </div>
      <div class="relative my-4 text-white flex w-full items-center justify-center md:my-7">
          <div class="absolute inset-0 flex items-center"><div class="border-[#122537] w-full border-t-2"></div></div>
