<template>
  <div>
    ...
    <div
      class="z-40 h-screen w-64 fixed lg:block hidden left-0 top-16 bg-[#192C3D]"
    >
    ...
    <div class="lg:pl-64 z-20">
      <div
        class="bg-[url('./assets/herobg.webp')] z-10 relative w-full bg-cover"
      >
        <div
          class="absolute inset-0 w-1/6 -left-10 bg-gradient-to-r from-[#0A1C2D] to-[#0A2334] blur-2xl z-20"
        ></div>
